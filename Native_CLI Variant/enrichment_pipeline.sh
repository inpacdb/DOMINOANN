...
#printf "\n\n\n\e[32m\033[1m\t Constructing the NCBI.sqlite file : \033[0m"
printf "\n\033[1;33m====================================================================\033[0m\n"
...
while true; do
read -r -e -d $'\n' -p 'Regenerate NCBI.sqlite (y/n): ' ncbi_sqlite_new;
